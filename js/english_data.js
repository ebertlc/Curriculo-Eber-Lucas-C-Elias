var CV = {
  ...
  /* ── Summary ────────────────────────────────── */
  resumoVisivel: false,
  resumo: `Mid-level DBA with experience in Federal Government agencies (MPDFT and MIDR), where I developed solid expertise in SQL Server, Oracle, and PostgreSQL database administration. I have strong skills in high availability with AlwaysOn and replication, automation using T-SQL scripts, PL/SQL, and Ansible, backup management with Commvault, and ETL package development. I seek to further deepen my knowledge in data administration within complex, high-demand environments, ensuring security, performance, and reliability.`,
